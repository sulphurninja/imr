        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div
            className={`${isMobileMenuOpen ? 'flex' : 'hidden'
              } md:flex justify-center md:items-center gap-0 md:gap-2 xl:gap-10 absolute md:relative right-0 bg-black md:bg-transparent top-16 md:top-0 pb-4 w-full font-mono font-extrabold pt-2 md:w-auto md:flex-row md:space-x-4 transition-all duration-300`}
          >
            <a
              href="#"
